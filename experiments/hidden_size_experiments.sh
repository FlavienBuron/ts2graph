    ...
    python -u main.py -d air -g knn 100 -e 10 -hd 8 -ln 1 -v 0 | tee -a "$LOGFILE"
    ...
    python -u main.py -d air -g knn 100 -e 10 -hd 16 -ln 1 -v 0 | tee -a "$LOGFILE"
    ...
    python -u main.py -d air -g knn 100 -e 10 -hd 64 -ln 1 -v 0 | tee -a "$LOGFILE"
