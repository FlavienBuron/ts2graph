    ...
    python -u main.py -d air -g knn 50 -e 10 -it 2 -ln 1 -v 0 | tee -a "$LOGFILE"
    ...
    python -u main.py -d air -g knn 50 -e 10 -it 3 -ln 1 -v 0 | tee -a "$LOGFILE"
    ...
    python -u main.py -d air -g knn 50 -e 10 -it 4 -ln 1 -v 0 | tee -a "$LOGFILE"
